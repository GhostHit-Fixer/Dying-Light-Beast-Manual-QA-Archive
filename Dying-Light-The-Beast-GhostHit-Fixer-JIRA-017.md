...
## Environment
* **Verified regression: Behavior was 100% stable in v1.5 on the exact same hardware configuration.
...
##[COMBAT INTERACTION MATRIX - SUB-TEST LOGS]:
* ** Movement Check: Attempt to sprint directly through the physical model of any Military AI asset.
* ** Melee Check: Execute consecutive melee attacks using a one-handed Axe and standard kicks into the center of the AI meshes.
* ** Ballistic Check: Equip the Iconic Rifle and fire several rounds directly into the torso of the AI assets.
* ** Environmental Check: Fire into the environmental fuel spill at their feet.
* ** Progression Check: Interact with the central locked crate, complete the lockpicking minigame, and empty the loot array.
